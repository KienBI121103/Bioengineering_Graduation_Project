...
# Read the CSV file
df = pd.read_csv("amrfinder_summary.csv")
...
ax.set_ylabel('Number of resistance genes', fontsize=12, fontweight='bold')
...
# Save the plot
plt.savefig('amr_resistance_plot.png', dpi=300, bbox_inches='tight')
print(f"\nPlot saved as: amr_resistance_plot.png")
