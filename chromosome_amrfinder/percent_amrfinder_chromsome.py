...
base_dir = "C:/Users/hoahoa/Documents/DSA_study/Thesis_project/chromosome_amrfinder"
...
csv_output = "amr_gene_file_frequency_chromosome.csv"
...
plt.ylabel('Percent(%)')
plt.xlabel('Gene')
plt.title(f'Percent Antibiotics Resistance Gene in Chromosome (n={success_files} samples)')
plt.xticks(rotation=45, ha='right', fontsize=4)
plt.grid(axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()

# Lưu biểu đồ
plot_output = "amr_gene_file_frequency_chromosome.png"
