...
# Read the CSV file
df = pd.read_csv("amrfinder_plasmid_summary.csv")
...
ax.set_ylabel('Number of resistance genes in plasmid', fontsize=12, fontweight='bold')
...
# Save the plot
plt.savefig('amr_plasmid_plot.png', dpi=300, bbox_inches='tight')
print(f"\nPlot saved as: amr_plasmid_plot.png")
